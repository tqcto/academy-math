  ...
  \section{場合の数}
    ...
    \begin{multicols*}{2}
      \subsection{用語の定義}
        ...
        \paragraph{試行}\mbox{}\\
          試行とは、起こりうる結果がいくつかあり、そのどれか$\ds 1$つだけが\overdot{偶}\overdot{然}\overdot{起}\overdot{こ}\overdot{る}流れのことである。 

      \subsection{場合という言葉について}
      ...
      \subsection{和の法則}
        まず事象$\ds A, B$があるとき、$\ds A, B$が同時に起こらない場合を考えよう。\par
        このとき事象$\ds A, B$に対するそれらの
