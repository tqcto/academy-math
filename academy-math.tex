...
\begin{multicols*}{2}
  ...
  \subsubsection{単射（行先がかぶらない写像）}
    ...
    \begin{tikzpicture}[auto]
      ...
      %x->y
      \node[set label, text=black] (x) at (0, 15pt) {$\ds x$};
      \node[set label, text=black] (y) at (80pt, 15pt) {$\ds y$};
      \draw[->] (0, 10pt) to node {$\scriptstyle f(x)$} (80pt, 10pt);

      %x'->y'
      \node[set label, text=black] (x') at (0, -3pt) {$\ds x'$};
      \node[set label, text=black] (y') at (80pt, -3pt) {$\ds y'$};
      \draw[->] (0, -10pt) to node {$\scriptstyle f(x')$} (80pt, -10pt);
  ...
  \subsubsection{全射}
    ...
    \begin{tikzpicture}[auto]
      ...
      %x'->y'
      \node[set label, text=black] (x') at (0, 5pt) {$\ds x'$};
      \node[set label, text=black] (y') at (80pt, -3pt) {$\ds y'$};

      %x''->y'
      \node[set label, text=black] (x'') at (0, -13pt) {$\ds x''$};
