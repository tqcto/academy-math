...
\part{基礎の確認}
  ...
  \section{集合論}
    ...
    \subsection{上限と下限}
      ...
      と定義して、このような$\ds S$を"$\ds A$の上界"と言い、この上界の最小値$\ds \min S$を"$\ds A$の上限"と言い$\ds \sup A$と書く。
      ...
      と定義して、このような$\ds I$を"$\ds A$の下界"と言い、この下界の最大値$\ds \max I$を"$\ds A$の下限"と言い$\ds \inf A$と書く。\par
