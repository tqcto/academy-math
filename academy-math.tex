  ...
  \section{場合の数}
    ...
    \begin{multicols*}{2}
      ...
      \subsection{和の法則}
        ...
        事象$\ds A, B$の起こり方の総数とはつまり、事象$\ds A, B$の和集合の「根元事象の数」である。\par
        つまり事象$\ds A, B$の根元事象の集合をそれぞれ$\ds \mathbb{A}, \mathbb{B}$とすると、
        ...
        であるから、事象$\ds A, B$の和集合$\ds \mathbb{A} \cup \mathbb{B}$の根元事象の数、つまり要素数は

        \begin{equation*}
          \begin{split}
            $\ds n( \mathbb{A} \cup \mathbb{B} ) = n(\mathbb{A}) + n(\mathbb{B})$
          \end{split}
        \end{equation*}
