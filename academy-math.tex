...
\part{基礎編}
  ...
  \section{論理学}
    ...
    \subsection{命題論理と述語論理}
      ...
      \footnote{
        論理学においてはこの演算子を\textbf{論理演算子}、あるいは\textbf{論理結合子}と呼ぶ。
      }
        ...
        \begin{center}
          \begin{table}[h]
            ...
            \begin{tabular}{c|c||c|c|c|c}
              \truthtable{A,B}{$A$,$B$}{A&B, A|B, >>(A;B), !A} {$A \land B, A \lor B, A \Rightarrow B, \lnot A$}{$1$}{$0$}
            \end{tabular}
          \end{table}
        \end{center}
          ...
          \begin{center}
            \begin{table}[h]
              ...
              \begin{tabular}{lll}
                ...
                & $\ds "p \Longrightarrow q" \Longleftrightarrow "\lnot p \Longleftrightarrow \lnot q"$ & 対偶則
            ...
            \begin{table}[h]
              ...
              \begin{tabular}{lll}
                ...
                $\ds "p \Longrightarrow q"$ & $\ds \Longleftrightarrow "\lnot p \lor (p \land q)"$                    & $\ds (\because \ref{longrightarrow-iff})$\\
                                            ...
                                            & $\ds \Longleftrightarrow "\lnot p \lor q"$                              & \begin{tabular}{r}
                                                                                                                          $\ds (\because 常に真である恒真命題$\ds "\lnot p \lor p" \Leftrightarrow \top$との論理積(and)は、\\
                                                                                                                          $\ds \top$との論理積を省いても同じ主張であると言える)$\\
                                                                                                                        \end{tabular}\\

              \end{tabular}
            \end{table}
          \end{center}
          \footnote{\land で結ばれるものを論理積といい、\lor で結ばれるものを論理和という。}
          よってまとめれば
          \begin{equation*}
            \begin{split}
